...
var c = {
  init: function init(container) {
    ...
    c.ui = {
      ...
      button2: (0, _jquery.default)("#minus2"),
...
var $ele = (0, _jquery.default)($html).appendTo('body>.page');
var $tabBar = (0, _jquery.default)('#app2 .tab-bar');
var $tabCon = (0, _jquery.default)('#app2 .tab-content');
var localKey = 'app2.index';
var active = localStorage.getItem(localKey) || 0;
$tabBar.on('click', 'li', function (e) {
  var $li = (0, _jquery.default)(e.currentTarget);
  var index = $li.index();
  localStorage.setItem(localKey, index);
  $tabCon.children().children().eq(index).addClass('active').siblings().removeClass('active');
});
...
var $html = "\n<!-- app3 -->\n<div id=\"app3\">\n    <div id=\"box\"></div>\n</div>\n";
var $ele = (0, _jquery.default)($html).appendTo((0, _jquery.default)('body>.page'));
var $box = (0, _jquery.default)("#box");
var localKey = 'app.animation';
